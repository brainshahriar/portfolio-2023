    ...
    <div className="left-bar">
      ...
      <section className="left-bar__info-section">
        ...
        <div className="left-bar__info-section__item">
          ...
          <p className="left-bar__info-section__value">Dhaka,Bangladesh</p>
        </div>
      </section>
      <hr className="left-bar__line" />
      <section className="left-bar__progress-section">
        <p className="left-bar__progress-section__title">Languages</p>
      ...
      <section className="left-bar__extra-skill-section">
        ...
        {
            extraSkillsData().map((data,i)=><div key={i} className="left-bar__extra-skill-section__area">
            <AiOutlineBlock className="left-bar__extra-skill-section__icon" />
            <p className="left-bar__extra-skill-section__text">{data}</p>
          </div>)
        }
      </section>
      <hr className="left-bar__line" />
